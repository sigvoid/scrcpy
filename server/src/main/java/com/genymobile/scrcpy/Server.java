    ...
    private static void scrcpy(Options options) throws IOException, ConfigurationException {
        ...
        try {
            ...
            if (audio) {
                ...
                Streamer audioStreamer = new Streamer(connection.getAudioOsm(), audioCodec, options.getSendCodecMeta(), options.getSendFrameMeta());
            ...
            if (video) {
                Streamer videoStreamer = new Streamer(connection.getVideoOsm(), options.getVideoCodec(), options.getSendCodecMeta(),
